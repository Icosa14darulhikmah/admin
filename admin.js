...
function renderTable(){
  const hasRegId = currentHeaders.includes('No. Registrasi');
  const mainCount = currentRows.filter(r => !r['Peran'] || r['Peran'] === 'Ketua Tim' || r['Peran'] === 'Peserta').length;
